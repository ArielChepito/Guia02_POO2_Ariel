<%-- 
    Document   : reporte3
    Created on : 06-ago-2016, 21:50:38
    Author     : Ariel
--%>
...
String fechaInicio=request.getParameter("date1");
String fechaFin=request.getParameter("date2");
...
parameters.put("parameter1", fechaInicio); 
parameters.put("parameter2", fechaFin); 
